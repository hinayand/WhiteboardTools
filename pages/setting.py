...
def setting(page: ft.Page) -> ft.View:
    material3_switch = ft.Switch(label="使用新版本的Material Design", on_change=lambda _: theme_change())
    ...
    def theme_change():
        ...
        try:
            page.dark_theme.use_material3 = material3_switch.value
